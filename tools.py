...
from iwort import celsius_to_fahrenheit
from iwort import sg_to_plato, plato_to_sg, sg_to_brix, brix_to_sg, brix_to_plato
...
class Refractometer():
    ...
    prefer those whose outputs in Plato.  Anyway, iwort can convert between
