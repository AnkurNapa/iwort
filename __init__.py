...
"""
iwort - basic maths around brewing.

Overview
This Python module implements some equations used by homebrewers.  Although
there is no canonical formulas for procedures covered by iwort, I tried to
use those referenced by the most renowned sources.  Therefore, it is highly
probable that if you compare the results given by iwort with other softwares,
